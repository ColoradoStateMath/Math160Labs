...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [very thick, penColor, samples=150,smooth,domain=(20:70)] {x^(1/3))};
          \addplot [very thick, penColor2, domain=(20:70)] {x/27+2};
          \addplot [very thick, penColor3, domain=(20:70)] {x/48+8/3};
          \addplot [textColor,dashed] plot coordinates {(50,0) (50,3.68403149864)};
          
          \node at (axis cs:55,3.8) [penColor] {$f$};
          \node at (axis cs:55,4.3) [penColor2] {$m$};
          \node at (axis cs:55,4.3) [penColor3] {$\l$};
