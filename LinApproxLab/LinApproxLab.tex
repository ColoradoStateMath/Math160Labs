...
\begin{question}
What is the linear approximation of $\sin(\theta)$ at the above theta value?
...
are angles that deviate no more that $15^\circ$ from equilibrium.
...
This is our equilibrium solution! This function is $0$ at $t=0$. In other
words, this is our solution when we put the ball directly below the point
that the string is hanging from. This is no surprise though. We want to
find out what happens when we place the ball somewhere where the ball actually swings.
