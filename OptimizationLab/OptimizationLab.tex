...
\hspace{2cm}What is the domain of $A(n)$? \\ %%TODO dropbox integers/real numbers, greater/less than $\answer{3}$
...
\hspace{2cm}Yikes! Ok, that's a beast, but let's not lose our heads. We're hunting critical points after all. Where do critical points occur?\\ %%TODO select all correct answers
...
\hspace{2cm}So we found $\answer{0}$ critical points. Does this mean $A(n)$ can't have any extreme values?\\ %%TODO mult choice
