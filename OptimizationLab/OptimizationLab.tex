...
\begin{hint}
  ...
  \begin{align*}
     4n\sin(\frac{\pi}{n}) &= 4\frac{1}{1/n})\sin(\frac{\pi}{n})\\
     &= \frac{4\,\answer{\pi}\,\sin(\frac{\pi}{n})}{\answer{\pi/n}}.
  \end{align*}
\end{hint}
\begin{hint}
  \begin{align*}
     Then \lim_{n \to \infty} 4n\sin(\frac{\pi}{n}) &= \lim_{n \to \infty} \frac{4\pi\sin(\frac{\pi}{n})}{(\frac{\pi}{n})}\\
     &= \answer{4\pi}.
  \end{align*}
\end{hint}
\end{problem}
