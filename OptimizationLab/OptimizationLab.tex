...
Then what is the total area of an n-sided regular polygon in terms of $n$ and $r$? Area $=\answer[given]{(n)(r^2)\sin(\pi/n)\cos(\pi/n)}$.
...
Enter the derivative you computed earlier.
...
\end{hint}
\begin{hint}
    What is the limit of the numerator? \[\lim_{n \to \infty} P^2\cos(\pi/n) = \answer{P^2}\]
\begin{hint}
